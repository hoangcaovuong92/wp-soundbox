...
jQuery(document).ready(function($){
	// Extra Media Post
	/*jQuery('#style_download').change(function(event) {
		var parents = jQuery(this).parents('#meta_download');
		if(jQuery(this).val()=='video'){
			parents.find('#video').show();
			parents.find('#audio').hide();
		}else{
			parents.find('#audio').show();
			parents.find('#video').hide();
		}
	});*/
