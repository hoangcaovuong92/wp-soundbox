<?php
	add_action( 'customize_preview_init', 'soundbax_customize_live_preview_color');
	if(!function_exists ('soundbax_customize_live_preview_color')){
		function soundbax_customize_live_preview_color($wp_customize){
			add_action( 'wp_footer', 'soundbax_customize_preview', 50);
			add_action( 'wp_enqueue_scripts', 'soundbax_set_footer_primary_color' , 100000);
		}
	}
	
	// Live Priview Color
	function soundbax_customize_preview($wp_customize) { ?>
	...
	function soundbax_get_css_xml_file($xml_file_customize,$status_privew){
	...
	function soundbax_set_footer_primary_color(){
		...
		$file_xml_new		=  get_theme_mod( 'soundbax_styling_primary_color' ,'color_default');
		$status_privew	 	= 0;
		...
		$custom_css = soundbax_get_css_xml_file($file_xml_new,$status_privew);
