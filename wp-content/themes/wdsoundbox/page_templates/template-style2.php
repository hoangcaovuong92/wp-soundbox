<?php
/*
Template Name: style 2 Template
*/
get_header(); 

	/*CUSTOM DEFAULT*/
	$layout 		= get_theme_mod('soundbax_template2_layout','0-1-0');
	$sidebar_left 	= get_theme_mod('soundbax_default_template2_sidebar_left','sidebar');
	$sidebar_right 	= get_theme_mod('soundbax_default_teamplate2_sidebar_right','sidebar');
