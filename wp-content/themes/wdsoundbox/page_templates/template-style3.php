<?php
/*
Template Name: style3 Template
*/
get_header(); 

	/*CUSTOM DEFAULT*/
	$$layout 		= get_theme_mod('soundbax_template3_layout','0-1-0');
	$sidebar_left 	= get_theme_mod('soundbax_default_template3_sidebar_left','sidebar');
	$sidebar_right 	= get_theme_mod('soundbax_default_teamplate3_sidebar_right','sidebar');
