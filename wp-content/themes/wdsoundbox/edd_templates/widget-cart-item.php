<li class="edd-cart-item">
	<div><img src="{item_thumbnail_download}" alt="product download"></div>
	...
	<a href="{remove_url}" data-cart-item="{cart_item_id}" data-download-id="{item_id}" data-action="edd_remove_from_cart" class="edd-remove-from-cart"><?php _e( 'remove', 'wdsoundbox' ); ?></a>
</li>
